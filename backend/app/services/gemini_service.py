...
class GeminiService:
    def __init__(self, api_key: str, redis_url: str = "redis://localhost:6379"):
        ...
        self.chunk_semaphore = asyncio.Semaphore(5)  # Limit concurrent API calls
    ...
    async def _process_chunk(self, chunk: str, session: aiohttp.ClientSession) -> List[dict]:
        ...
        async with self.chunk_semaphore:  # Rate limit API calls
            try:
    ...
    async def process_transcript(self, transcript: str) -> dict:
        ...
        # Efficient deduplication using a dictionary
        unique_issues = {}
